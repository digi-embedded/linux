...
#define MCA_LAST_WAKEUP_REASON_7	0x00a7

#define MCA_MPU_NVRAM_START		0x00b0
#define MCA_MPU_NVRAM_END		0x00b7

#define MCA_RESET_SAFE_TIMEOUT		0x00b8
#define MCA_PWROFF_SAFE_TIMEOUT		0x00b9
...
#define MCA_RTC_PREPARE_DATETIME	0x0123
#define MCA_RTC_PREPARE_ALARM		0x0124
...
#define MCA_REG_ADC_BUFF_SAMPLE_0	0x0810
#define MCA_REG_ADC_BUFF_SAMPLE_1	0x0811
#define MCA_REG_ADC_BUFF_SAMPLE_2	0x0812
#define MCA_REG_ADC_BUFF_SAMPLE_3	0x0813
#define MCA_REG_ADC_BUFF_SAMPLE_4	0x0814
#define MCA_REG_ADC_BUFF_SAMPLE_5	0x0815
#define MCA_REG_ADC_BUFF_SAMPLE_6	0x0816
#define MCA_REG_ADC_BUFF_SAMPLE_7	0x0817
#define MCA_REG_ADC_BUFF_SAMPLE_8	0x0818
#define MCA_REG_ADC_BUFF_SAMPLE_9	0x0819
#define MCA_REG_ADC_BUFF_SAMPLE_10	0x081a
#define MCA_REG_ADC_BUFF_SAMPLE_11	0x081b
#define MCA_REG_ADC_BUFF_SAMPLE_12	0x081c
#define MCA_REG_ADC_BUFF_SAMPLE_13	0x081d
#define MCA_REG_ADC_BUFF_SAMPLE_14	0x081e
#define MCA_REG_ADC_BUFF_SAMPLE_15	0x081f
#define MCA_REG_ADC_BUFF_SAMPLE_16	0x0820
#define MCA_REG_ADC_BUFF_SAMPLE_17	0x0821
#define MCA_REG_ADC_BUFF_SAMPLE_18	0x0822
#define MCA_REG_ADC_BUFF_SAMPLE_19	0x0823
#define MCA_REG_ADC_BUFF_SAMPLE_20	0x0824
#define MCA_REG_ADC_BUFF_SAMPLE_21	0x0825
#define MCA_REG_ADC_BUFF_SAMPLE_22	0x0826
#define MCA_REG_ADC_BUFF_SAMPLE_23	0x0827
#define MCA_REG_ADC_BUFF_SAMPLE_24	0x0828
#define MCA_REG_ADC_BUFF_SAMPLE_25	0x0829
#define MCA_REG_ADC_BUFF_SAMPLE_26	0x082a
#define MCA_REG_ADC_BUFF_SAMPLE_27	0x082b
#define MCA_REG_ADC_BUFF_SAMPLE_28	0x082c
#define MCA_REG_ADC_BUFF_SAMPLE_29	0x082d
#define MCA_REG_ADC_BUFF_SAMPLE_30	0x082e
#define MCA_REG_ADC_BUFF_SAMPLE_31	0x082f

/* EP9, UART register base addresses, offsets and masks. */
#define MCA_UART0_OFFSET		0x0900
#define MCA_UART1_OFFSET		0x0920
#define MCA_UART2_OFFSET		0x0940
...
#define MCA_PWR_KEY_OFF_UP_EN   BIT(7)

/* MCA_PWR_STATUS_0 (addr=0x0029) */
#define MCA_PWR_BUT_OFF_UPDOWN_BIT	BIT(0)
...
#define MCA_RESET_SAFE		BIT(6)
#define MCA_PWROFF_SAFE		BIT(7)
...
/* MCA_LAST_MCA_RESET_n (addr=0x0098 & 0x009b) */
#define MCA_LAST_MCA_RST_LLW	BIT(0)
#define MCA_LAST_MCA_RST_LVD	BIT(1)
#define MCA_LAST_MCA_RST_WD	BIT(5)
#define MCA_LAST_MCA_RST_PIN	BIT(6)
#define MCA_LAST_MCA_RST_PWRON	BIT(7)
#define MCA_LAST_MCA_RST_LOCKUP	BIT(9)
#define MCA_LAST_MCA_RST_SW	BIT(10)
#define MCA_LAST_MCA_RST_MDMAPP	BIT(11)
#define MCA_LAST_MCA_RST_SMAE	BIT(13)

/* MCA_LAST_MPU_RESET_n (addr=0x009c & 0x009f) */
#define MCA_LAST_MPU_RST_PWRON	BIT(0)
#define MCA_LAST_MPU_RST_SYSR	BIT(1)
#define MCA_LAST_MPU_RST_WD	BIT(2)
#define MCA_LAST_MPU_RST_OFFWAKE	BIT(3)
#define MCA_LAST_MPU_RST_MCARST	BIT(4)

/* MCA_LAST_WAKEUP_REASON_n (addr=0x00a0 & 0x00a3) */
#define MCA_LAST_WAKEUP_PWRIO	BIT_ULL(0)
#define MCA_LAST_WAKEUP_TIMER	BIT_ULL(1)
#define MCA_LAST_WAKEUP_RTC	BIT_ULL(2)
#define MCA_LAST_WAKEUP_LPUART	BIT_ULL(3)
#define MCA_LAST_WAKEUP_TAMPER0	BIT_ULL(4)
#define MCA_LAST_WAKEUP_TAMPER1	BIT_ULL(5)
#define MCA_LAST_WAKEUP_TAMPER2	BIT_ULL(6)
#define MCA_LAST_WAKEUP_TAMPER3	BIT_ULL(7)
#define MCA_LAST_WAKEUP_IO0	BIT_ULL(8)
#define MCA_LAST_WAKEUP_IO1	BIT_ULL(9)
#define MCA_LAST_WAKEUP_IO2	BIT_ULL(10)
#define MCA_LAST_WAKEUP_IO3	BIT_ULL(11)
#define MCA_LAST_WAKEUP_IO4	BIT_ULL(12)
#define MCA_LAST_WAKEUP_IO5	BIT_ULL(13)
#define MCA_LAST_WAKEUP_IO6	BIT_ULL(14)
#define MCA_LAST_WAKEUP_IO7	BIT_ULL(15)
#define MCA_LAST_WAKEUP_VCC	BIT_ULL(16)
#define MCA_LAST_WAKEUP_CPU	BIT_ULL(17)

/* Values exclusive to the KL17 */
#define MCA_KL17_LAST_WAKEUP_IO8	BIT_ULL(16)
#define MCA_KL17_LAST_WAKEUP_IO9	BIT_ULL(17)
#define MCA_KL17_LAST_WAKEUP_IO10	BIT_ULL(18)
#define MCA_KL17_LAST_WAKEUP_IO11	BIT_ULL(19)
#define MCA_KL17_LAST_WAKEUP_IO12	BIT_ULL(20)
#define MCA_KL17_LAST_WAKEUP_IO13	BIT_ULL(21)
#define MCA_KL17_LAST_WAKEUP_IO14	BIT_ULL(22)
#define MCA_KL17_LAST_WAKEUP_IO15	BIT_ULL(23)
#define MCA_KL17_LAST_WAKEUP_IO16	BIT_ULL(24)
#define MCA_KL17_LAST_WAKEUP_IO17	BIT_ULL(25)
#define MCA_KL17_LAST_WAKEUP_IO18	BIT_ULL(26)
#define MCA_KL17_LAST_WAKEUP_IO19	BIT_ULL(27)
#define MCA_KL17_LAST_WAKEUP_IO20	BIT_ULL(28)
#define MCA_KL17_LAST_WAKEUP_IO21	BIT_ULL(29)
#define MCA_KL17_LAST_WAKEUP_VCC	BIT_ULL(30)
#define MCA_KL17_LAST_WAKEUP_CPU	BIT_ULL(31)

/* Values exclusive to the STM32U031. Extended to addr 0x00a4 & 0x00a7 */
#define MCA_STM32U031_LAST_WAKEUP_IO8	BIT_ULL(16)
#define MCA_STM32U031_LAST_WAKEUP_IO9	BIT_ULL(17)
#define MCA_STM32U031_LAST_WAKEUP_IO10	BIT_ULL(18)
#define MCA_STM32U031_LAST_WAKEUP_IO11	BIT_ULL(19)
#define MCA_STM32U031_LAST_WAKEUP_IO12	BIT_ULL(20)
#define MCA_STM32U031_LAST_WAKEUP_IO13	BIT_ULL(21)
#define MCA_STM32U031_LAST_WAKEUP_IO14	BIT_ULL(22)
#define MCA_STM32U031_LAST_WAKEUP_IO15	BIT_ULL(23)
#define MCA_STM32U031_LAST_WAKEUP_IO16	BIT_ULL(24)
#define MCA_STM32U031_LAST_WAKEUP_IO17	BIT_ULL(25)
#define MCA_STM32U031_LAST_WAKEUP_IO18	BIT_ULL(26)
#define MCA_STM32U031_LAST_WAKEUP_IO19	BIT_ULL(27)
#define MCA_STM32U031_LAST_WAKEUP_IO20	BIT_ULL(28)
#define MCA_STM32U031_LAST_WAKEUP_IO21	BIT_ULL(29)
#define MCA_STM32U031_LAST_WAKEUP_IO22	BIT_ULL(30)
#define MCA_STM32U031_LAST_WAKEUP_IO23	BIT_ULL(31)
#define MCA_STM32U031_LAST_WAKEUP_IO24	BIT_ULL(32)
#define MCA_STM32U031_LAST_WAKEUP_IO25	BIT_ULL(33)
#define MCA_STM32U031_LAST_WAKEUP_IO26	BIT_ULL(34)
#define MCA_STM32U031_LAST_WAKEUP_IO27	BIT_ULL(35)
#define MCA_STM32U031_LAST_WAKEUP_IO28	BIT_ULL(36)
#define MCA_STM32U031_LAST_WAKEUP_VCC	BIT_ULL(37)
#define MCA_STM32U031_LAST_WAKEUP_CPU	BIT_ULL(38)
