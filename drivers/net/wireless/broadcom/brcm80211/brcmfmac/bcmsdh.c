...
static const struct sdio_device_id brcmf_sdmmc_ids[] = {
	...
	CYW_SDIO_DEVICE(SDIO_DEVICE_ID_CYPRESS_43439),
	...
	CYW_SDIO_DEVICE(SDIO_DEVICE_ID_CYPRESS_55572),
	CYW_SDIO_DEVICE(SDIO_DEVICE_ID_CYPRESS_55500),
	CYW_SDIO_DEVICE(SDIO_DEVICE_ID_CYPRESS_43022),
	{ /* end: all zeroes */ }
};
