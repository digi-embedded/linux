...
static const struct regmap_range mca_cc8x_writeable_ranges[] = {
	...
	regmap_reg_range(MCA_CC8X_IRQ_STATUS_0, MCA_CC8X_IRQ_MASK_3),
	regmap_reg_range(MCA_CC8X_PWR_CTRL_0, MCA_CC8X_PWR_KEY_GUARD),
	regmap_reg_range(MCA_CC8X_CTRL_UNLOCK_0, MCA_CC8X_CTRL_UNLOCK_3),
	regmap_reg_range(MCA_CC8X_CTRL_0, MCA_CC8X_CTRL_0),
	regmap_reg_range(MCA_CC8X_TAMPER0_CFG0, MCA_CC8X_TAMPER0_EVENT),
	regmap_reg_range(MCA_CC8X_TAMPER1_CFG0, MCA_CC8X_TAMPER1_EVENT),
	regmap_reg_range(MCA_CC8X_TAMPER2_CFG0, MCA_CC8X_TAMPER2_THRESH_HI_H),
	regmap_reg_range(MCA_CC8X_TAMPER3_CFG0, MCA_CC8X_TAMPER3_THRESH_HI_H),
	regmap_reg_range(MCA_CC8X_RTC_CONTROL, MCA_CC8X_RTC_CONTROL),
	regmap_reg_range(MCA_CC8X_RTC_COUNT_YEAR_L, MCA_CC8X_RTC_ALARM_SEC),
	regmap_reg_range(MCA_CC8X_WDT_CONTROL, MCA_CC8X_WDT_REFRESH_3),
...
static const struct regmap_range mca_cc8x_volatile_ranges[] = {
	...
	regmap_reg_range(MCA_CC8X_IRQ_STATUS_0, MCA_CC8X_IRQ_STATUS_3),
	regmap_reg_range(MCA_CC8X_TAMPER0_DATE_START, MCA_CC8X_TAMPER0_EVENT),
	regmap_reg_range(MCA_CC8X_TAMPER1_DATE_START, MCA_CC8X_TAMPER1_EVENT),
	regmap_reg_range(MCA_CC8X_TAMPER2_DATE_START, MCA_CC8X_TAMPER2_EVENT),
	regmap_reg_range(MCA_CC8X_TAMPER3_DATE_START, MCA_CC8X_TAMPER3_EVENT),
	...
	regmap_reg_range(MCA_CC8X_MPU_NVRAM_START, MCA_CC8X_MPU_NVRAM_END),
	regmap_reg_range(MCA_CC8X_RTC_COUNT_YEAR_L, MCA_CC8X_RTC_COUNT_SEC),
	regmap_reg_range(MCA_GPIO_DATA_0, MCA_GPIO_DATA_7),
	regmap_reg_range(MCA_GPIO_IRQ_STATUS_0, MCA_GPIO_IRQ_STATUS_7),
	regmap_reg_range(MCA_CC8X_PWR_CTRL_0, MCA_CC8X_PWR_STATUS_0),
	...
	regmap_reg_range(MCA_CC8X_PWR_KEY_DEBOUNCE, MCA_CC8X_PWR_KEY_GUARD),
	regmap_reg_range(MCA_CC8X_CTRL_0, MCA_CC8X_CTRL_0),
	regmap_reg_range(MCA_CC8X_TAMPER0_CFG0, MCA_CC8X_TAMPER0_DELAY_PWROFF),
	regmap_reg_range(MCA_CC8X_TAMPER1_CFG0, MCA_CC8X_TAMPER1_DELAY_PWROFF),
	regmap_reg_range(MCA_CC8X_TAMPER2_CFG0, MCA_CC8X_TAMPER2_THRESH_HI_H),
	regmap_reg_range(MCA_CC8X_TAMPER3_CFG0, MCA_CC8X_TAMPER3_THRESH_HI_H),
	regmap_reg_range(MCA_CC8X_RTC_CONTROL, MCA_CC8X_RTC_CONTROL),
	regmap_reg_range(MCA_CC8X_RTC_ALARM_YEAR_L, MCA_CC8X_RTC_ALARM_SEC),
	regmap_reg_range(MCA_CC8X_WDT_CONTROL, MCA_CC8X_WDT_TIMEOUT),
			       ...
			       const struct i2c_device_id *id)
{
	...
	mca = devm_kzalloc(&i2c->dev, sizeof(struct mca_cc8x), GFP_KERNEL);
	if (mca == NULL)
		return -ENOMEM;
...
{
	struct mca_cc8x *mca = i2c_get_clientdata(i2c);
...
/*
 * Use suspend_late/resume_early so the mca_cc8x continues being functional
